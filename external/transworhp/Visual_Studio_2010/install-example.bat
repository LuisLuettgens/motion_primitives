...
rmdir %INC%\base
mkdir %INC%\base
robocopy ..\src\base\ %INC%\base\ color4.h vektor.h point.h twstatus.h defines.h
...
robocopy TransWORHP\Release\ %DIRC%\release\ TransWORHP.dll TransWORHP_mini.dll libworhp.dll SDL2.dll libpng16.dll libiomp5md.dll

rem transworhp.xml worhp.xml flugzeug.xml laufkatze.xml

robocopy TransWORHP\Release\ %DIRC%\lib\ TransWORHP.lib TransWORHP_mini.lib

robocopy TransWORHP\lib32\ %DIRC%\lib SDL2.lib SDL2main.lib
