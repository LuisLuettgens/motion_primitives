...
public:
	...
	void SC_x_init(double *x, int i, int dis) {
		x[5] = 5;
	}
	void SC_u_init(double *u, int i, int dis) {
		u[0] = 0;
		u[1] = 0;
	}
...
// bei Plot zurückmachen.
	...
	void SC_ode(double *dx, double t, const double *x, const double *u, const double *p) {
	...
	bool SC_ode_diff(DiffStructure& s, double t, const double* x, const double* u, const double* p) {
	...
	bool SC_ode_diff_p(DiffStructure& s, double t, const double *x, const double *u, const double *p, int index) {
...
*/
	...
	void SC_u_boundary(double *u_low, double *u_upp) {
	...
	void SC_x_boundary(double *x_low, double *x_upp) {
