...
public:
	...
	*/
	virtual bool obj_structure(DiffStructure &s) {return false;}
	/** Ableitung der Zielfunktion.
	* optional
	* @param s Abhaengigkeit
	* @return true, wenn Ableitung benutzt werden soll
	*/
	virtual bool obj_diff(DiffStructure &s) {return false;}

	virtual void integral(double *f, double t, const double *x, const double *u, const double *p) {}
	virtual bool integral_structure(DiffStructure &s) {return false;}
	virtual bool integral_diff(DiffStructure &s, double t, const double *x, const double *u, const double *p) {return false;}

	/** ODE-System / Dynamik */
	virtual void ode(double *dx, double t, const double *x, const double *u, const double *p)=0;
	/** Struktur des ODE-System */
	virtual bool ode_structure(DiffStructure &s) {return false;}
	/** Ableitung des ODE-System */
	virtual bool ode_diff(DiffStructure &s, double t, const double *x, const double *u, const double *p) {return false;}
	/** Ableitung des ODE-System nach freien Parameter */
	virtual bool ode_diff_p(DiffStructure &s, double t, const double *x, const double *u, const double *p, int index) {return false;}
	...
	virtual bool rand_structure(DiffStructure &s) {return false;}
	/** Ableitung der Randbedingungen */
	virtual bool rand_diff(DiffStructure &s) {return false;}
	...
	virtual bool neben_structure(DiffStructure &s) {return false;}
	...
	virtual bool neben_diff_p(DiffStructure &s, double t, const double *x, const double *u, const double *p, int index) {return false;}
