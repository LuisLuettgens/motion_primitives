...
class SplineLoad : public TransWorhp {
public:

	SplineLoad(int dis) : TransWorhp("Spline / Laden, Speichern",dis,3,1,0,0,0) {}
...
int main(int argv, char* argc[]) {
	...
	{
		SplineLoad ph(twparameter.NDIS);
