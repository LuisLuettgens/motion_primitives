...
REM robocopy ..\example_release\ TransWORHP\Release64 transworhp.xml
REM worhp.xml
REM robocopy TransWORHP\Release64 %DIRC% transworhp.xml
...
rmdir %INC%\core
mkdir %INC%\core
robocopy ..\src\core\ %INC%\core\ C_cs0.h defines.h TWfolder.h TWcount.h TWproblem.h TWParameter.h TWConsole.h TransWORHP.h Viewer.h butcher.h diffstructure.h newdouble.h worhp_info.h transworhpsharedmem.h LobattoPmTransWORHP.h PmTransWORHP.h ExplTransWorhp.h timing.h MagicTransWorhp.h
...
rmdir %INC%\glplot
mkdir %INC%\glplot
robocopy ..\src\glplot\ %INC%\glplot\ plot.h xopt_data.h functions.h baseplot.h threedplot.h
...
rmdir %INC%\xmlio
mkdir %INC%\xmlio
robocopy ..\src\xmlio\src\xmlio\ %INC%\xmlio textout.h xmlio.h conversion.h
