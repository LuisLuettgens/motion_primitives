...
public:
	...
	*/
	...
	/**
	* gibt an, welche Beschränkung an der Stelle i ist (ODE,RAND,NB,etc).
...
public:
	...
	/** Beschränkungsschranken */
	virtual void Boundary() = 0;

protected:
	/** Prüft, ob obere und untere Schranke für OptVar gleich sind
...
public:
	/// Beschränkungen
	void Constraints();
	/// Beschränkungen mit anderem G Vektor
...
public:
	...
	*/
	...
	int Delta1; /**< Offset für WORHP X */
	int Delta2; /**< Offset für WORHP G */
	int n_var; /**< Anzahl Optimierungsvariablen */
	int n_con; /**< Anzahl Beschränkungen */
	int n_zen;

	std::vector<double> T; /**< Zeit-Diskretisierung */

	double *X; /**< Optimierungsvektor */
	double *G; /**< Beschränkungen */
	double *ZEN; // Zen
	...
	*/
	...
	double Infty; ///< WORHP-Unendlich public: damit es von außen überprüfbar ist
...
protected:
	...
	// Hilfsvariablen für Auswertung ODE, NB, etc.
