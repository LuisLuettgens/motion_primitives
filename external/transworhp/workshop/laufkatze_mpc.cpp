...
return true;
	...
	/*	s.group(x_index(0,0), 1);
		s.group(x_index(0,1), 2);
		s.group(x_index(0,2), 2);
		s.group(x_index(0,3), 1);
		s.group(x_index(0,4), 3);
		s.group(x_index(0,5), 4);
		s.group(x_index(0,6), 2);
		s.group(x_index(0,7), 5);
		s.group(x_index(0,8), 3);
		s.group(u_index(0,0), 2);
		s.group(u_index(0,1), 1);
		s.group(p_indexode(0), 6);
