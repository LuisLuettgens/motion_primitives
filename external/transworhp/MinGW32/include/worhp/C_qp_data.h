...
/**
 * InitQPWorkspace initializes the QP Workspace structure with dummy values
 * @param[inout] qpws Set variables in @c qpws to dummy values.
 * @author       dlw
 */
DLL_PRIVATE void InitQPWorkspace(QPWorkspace *const qpws);
DLL_PRIVATE void FreeQPWorkspace(QPWorkspace *const qpws);

DLL_PRIVATE void InitQPProblemWorkspace(QPWorkspace *const qpws);
DLL_PRIVATE void ReallocateQPProblemWorkspace(QPWorkspace *const qpws, QPParams *const qppar);
DLL_PRIVATE void FreeQPProblemWorkspace(QPWorkspace *const qpws);

DLL_PRIVATE void InitQPQPSOLWorkspace(QPWorkspace *const qpws);
DLL_PRIVATE void ReallocateQPQPSOLWorkspace(QPWorkspace *const qpws, QPParams *const qppar);
DLL_PRIVATE void FreeQPQPSOLWorkspace(QPWorkspace *const qpws);

DLL_PRIVATE void InitQPIPWorkspace(QPWorkspace *const qpws);
DLL_PRIVATE void ReallocateQPIPWorkspace(QPWorkspace *const qpws, QPParams *const qppar);
DLL_PRIVATE void FreeQPIPWorkspace(QPWorkspace *const qpws);

DLL_PRIVATE void InitQPNEWLUWorkspace(QPWorkspace *const qpws);
DLL_PRIVATE void ReallocateQPNEWLUWorkspace(QPWorkspace *const qpws, QPParams *const qppar);
DLL_PRIVATE void FreeQPNEWLUWorkspace(QPWorkspace *const qpws);

DLL_PRIVATE void InitQPParameters(QPParams *const qppar);
