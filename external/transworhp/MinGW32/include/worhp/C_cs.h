...
void PrintWorhpMatrix(const WorhpMatrix *const WM);
int  InitWorhpMatrix(WorhpMatrix *WM, char name[], int extend, 
                     bool CCwithRow, _Bool CCwithCol);
void FreeWorhpMatrix(WorhpMatrix *WM);
void ZeroWorhpMatrix(WorhpMatrix *WM);
void CopyWorhpMatrix(WorhpMatrix *const to, const WorhpMatrix *const from);
