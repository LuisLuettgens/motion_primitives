...
public:
    ...
    virtual double EdgeCost ( const VertexData& va, const VertexData& vb ) const{return 0.;};
    virtual double EdgeCost ( const VertexData& va, const VertexData& vb, double dist ) const{return 0.;};
};
}
