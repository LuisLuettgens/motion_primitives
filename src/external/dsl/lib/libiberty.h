...
/* HAVE_DECL_* is a three-state macro: undefined, 0 or 1.  If it is
   ...
   is 1, we found it so don't provide any declaration at all.  */
    ...
    defined(__CYGWIN32__) || defined(HAVE_DECL_BASENAME)
...
extern char* make_relative_prefix
...
extern int pexecute PARAMS (
    ( const char*, char* const*, const char*, const char*, char**, char**, int ) );
