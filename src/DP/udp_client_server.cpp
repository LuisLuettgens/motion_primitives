...
//     int retval = select(f_socket + 1, &s, &s, &s, &timeout);//Didn't work
...
// int main() {
// 	udp_client_server::udp_server server("127.0.0.0", 59208);
// 	udp_client_server::udp_client client("127.0.0.0", 59207);
// 
// 	
// 	std::string str = "string";
// 	const char *sent_msg = str.c_str();
// 	char *recv_msg;
// 
// 	server.timed_recv(recv_msg, str.length(), 1);
// 	cout << "here" << endl;
// 	client.send(sent_msg, str.length());
// 	return 0;
// }